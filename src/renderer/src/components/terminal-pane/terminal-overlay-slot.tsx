...
export type TerminalOverlaySlotProps = {
...
export const TerminalOverlaySlot = memo(function TerminalOverlaySlot({
  ...
  const showPresentedTerminal = shouldShowPresentedTerminalOverlay({
    isPresented,
    isWorktreeActive,
    isWorktreePresented,
    showWorkspacePanes
  })
  const isInteractive = isTerminalOverlayInteractive({
    isVisible,
    isPresented,
    isWorktreePresented,
    showWorkspacePanes
  ...
  const style: React.CSSProperties = useMemo(
    ...
    [anchorName, isInteractive, measuredFallbackRect, overlayDisplay, showPresentedTerminal]
  )
  ...
  const terminalPane = (
    <TerminalPane
      ...
      isVisible={isTerminalOverlayPaneRendererVisible({
        isVisible,
